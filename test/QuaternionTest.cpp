...
TEST(Quaternion, MultiplyEqualsModifiesQuaternionAppropriately)
{
    ...
    EXPECT_FLOAT_EQ(expectedArray[3], quatA.w);
    EXPECT_FLOAT_EQ(expectedArray[0], quatA.x);
    EXPECT_FLOAT_EQ(expectedArray[1], quatA.y);
    EXPECT_FLOAT_EQ(expectedArray[2], quatA.z);
}
